...
<table class="table table-striped">
  ...
  for ($x = 1; $x <= 30; $x++) {?>
    <tr>
      <td><a href="<?= base_url(); ?>admin/Prodi/lihat_mhs">NIM</a></td>
      <td><a href="<?= base_url(); ?>admin/Prodi/lihat_mhs">NAMA</a></td>
      <td><a href="<?= base_url(); ?>admin/Prodi/lihat_mhs">NO. HP/WA</a></td>
    </tr>
  <?php }?>
  </tbody>
</table>
