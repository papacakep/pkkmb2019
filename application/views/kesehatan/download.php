...
<div class="accordion" id="accordionExample">
  <div class="card">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
     ...
     <a href="<?= base_url(); ?>admin/Kesehatan/tabel_mhs">Lihat</a>
      </div>
    </div>
  </div>
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
      Berupa Rundown Kegiatan Kesehatan dari awal sampai akhir selama dua hari, berikut materi dan tempat pelaksanaan.
     <a href="<?= base_url(); ?>Download/rundown_Kesehatan">Download</a>
      </div>
    </div>
  </div>
  <div class="card">
    ...
    <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
      <div class="card-body">
      Mendownload seluruh materi yang akan diberikan pada kegiatan Kesehatan.
     <a href="<?= base_url(); ?>Download/materi_Kesehatan">Download</a>
      </div>
    </div>
  </div>
  <div class="card">
    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
      <div class="card-body">
      Berupa Rundown Kegiatan Kesehatan dari awal sampai akhir selama tiga hari, berikut materi, tempat pelaksanaan dan pendamping.
