...
<div class="accordion" id="accordionExample">
  <div class="card">
  <div class="text-center"><a href="<?= base_url(); ?>admin/Sekretaris/edit_foto">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
        <div class="card-body">
        <form action="<?= base_url(); ?>admin/Sekretaris/edit_profil" method="post">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
            <input type="text" readonly class="form-control form-control-sm" id="colSekretaris" value="NIDN">
            </div>
        </div>
        <div class="form-group row">
