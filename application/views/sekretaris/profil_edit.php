  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
            <input type="text" class="form-control form-control-sm" id="colNIM" value="NIPY">
            </div>
            <label for="colSekretaris" class="col-sm-2 col-form-label col-form-label-sm">NIDN</label>
            <div class="col-sm-4">
            <input type="text" class="form-control form-control-sm" id="colSekretaris" value="NIDN">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
            <input type="text" class="form-control form-control-sm" id="coJBT" value="Jabatan">
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?= base_url(); ?>admin/Sekretaris/profil" class="btn btn-primary">OK</a>
      </div>
    </div>
  </div>
</div>