...
<div class="container">
<h5> <a href="<?= base_url(); ?>admin/Sekretaris/upload">Upload>></a><?php echo $title; ?></h5>
  ...
  <div class="text-center"><a href="<?= base_url(); ?>Download/detil_data">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
        ...
        <div class="form-group row">
            ...
            <label for="colSekretaris" class="col-sm-2 col-form-label col-form-label-sm">Program Studi</label>
            <div class="col-sm-5">
            <input type="text" readonly class="form-control form-control-sm" id="colSekretaris" value="Program Studi">
            </div>
        </div>
        <div class="form-group row">
