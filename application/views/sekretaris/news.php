  ...
  <div class="card shadow p-3 mb-5 bg-white rounded">
    ...
    <span class="d-inline-block text-truncate" style="max-width: 650px;">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="<?= base_url(); ?>admin/Sekretaris/c_news">Baca</a>
        <a class="dropdown-item" href="<?= base_url(); ?>admin/Sekretaris/e_news">Edit</a>
        <a class="dropdown-item" href="<?= base_url(); ?>admin/Sekretaris/d_news" data-toggle="modal" data-target="#deleteModal">Hapus</a>
      </div>
      </div>
  </div>
<?php }?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?= base_url(); ?>admin/Sekretaris/news" class="btn btn-primary">Ya</a>
      </div>
    </div>
  </div>
</div>