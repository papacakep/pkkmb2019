...
<div class="accordion" id="accordionExample">
  <div class="card">
  <div class="text-center"><a href="<?= base_url(); ?>maba/Profil/profil_gambar">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
        <div class="card-body">
        <form action="<?= base_url(); ?>maba/Profil/profil_id" method="post">
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
        <div class="card-body">        
        <form action="<?= base_url(); ?>maba/Profil/profil_alamat" method="post">
        <div class="form-group row">
  ...
  <div class="card">
    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
        <div class="card-body">        
        <form action="<?= base_url(); ?>maba/Profil/profil_ortu" method="post">
        <div class="form-group row">
  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
        <div class="card-body">
        <form action="<?= base_url(); ?>maba/Profil/profil_sekolah" method="post">
        <div class="form-group row">
  ...
  <div class="card">
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
        <div class="card-body">
        <form action="<?= base_url(); ?>maba/Profil/profil_fisik" method="post">
        <div class="form-group row">
